...
As discussed above, in frequentist statistics, $\prob{\theta}$ is either 0 or 1, and you don't get to pick what it is: it's just a fact of the universe whether your hypothesis is correct or not. This makes Bayes's theorem seem a little silly. Indeed, Bayes's theorem only makes sense if you think about probability in a \emph{Bayesian} sense, as a degree of confidence in something.
