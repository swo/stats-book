...
More concretely, if the probability of flipping heads is $p$, then the probability of flipping exactly $y$ heads and $n - y$ tails is precisely the binomial probability mass function:
\begin{equation}
