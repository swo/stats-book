...
In mathematical terms, we say that a random variable $X$ has some
...
For our second guess, let's use a more reasonable statistic. Say that
...
Note the subtlety in what we did: without actually knowing what $B$ is,
